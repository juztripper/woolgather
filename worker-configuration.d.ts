/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 2e84721d40363ca03aa5fa32b5636156)
// Runtime types generated with workerd@1.20260910.1 2026-09-06 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_AUTH_LIMITER: RateLimit;
	MCP_API_LIMITER: RateLimit;
	ASSETS: Fetcher;
	IDEA_GUIDANCE_EFFORT: string;
	BILLING_TEST_ENABLED: string;
	PLAN_ALLOWANCES_ENABLED: string;
	...
	MCP_ENABLED: string;
	MCP_ORIGIN: string;
	PROJECT_VOICE_SESSIONS: DurableObjectNamespace<import("./apps/api/src/worker").ProjectVoiceSession>;
	MCP_CONSENTS: DurableObjectNamespace<import("./apps/api/src/worker").McpConsentState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/api/src/worker");
		durableNamespaces: "ProjectVoiceSession" | "McpConsentState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IDEA_GUIDANCE_EFFORT" | "BILLING_TEST_ENABLED" | "PLAN_ALLOWANCES_ENABLED" | "STRIPE_BILLING_ENABLED" | "STRIPE_BILLING_MODE" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "ACCOUNT_ACTION_SECRET" | "RESEND_API_KEY" | "OPENAI_API_KEY" | "OPENAI_PROJECT_ID" | "IDEA_GUIDANCE_ENABLED" | "IDEA_GUIDANCE_MODEL" | "PROJECT_PLANNING_ENABLED" | "PROJECT_PLANNING_MODEL" | "PROJECT_VOICE_ENABLED" | "MCP_ENABLED" | "MCP_ORIGIN">> {}
}
